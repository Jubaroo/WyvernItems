...
import org.jubaroo.mods.wyvernitems.items.ChaosCrystal;
import org.jubaroo.mods.wyvernitems.utility.Crystals;
...
public class ChaosCrystalInfuseAction implements ModAction {
	...
	public BehaviourProvider getBehaviourProvider()
	{
		return new BehaviourProvider() {
			...
			{
				if(performer instanceof Player && source != null && object != null && source.getTemplateId() == ChaosCrystal.getId() && object.isRepairable() && object.getTemplateId() != ItemList.unfinishedItem){
			...
			public boolean action(Action act, Creature performer, Item source, Item target, short action, float counter)
			{
				try{
					if(performer instanceof Player){
						if(source.getTemplate().getTemplateId() != ChaosCrystal.getId()){
