...
import org.jubaroo.mods.wyvernitems.items.EnchantersCrystal;
...
public class EnchantersCrystalInfuseAction implements ModAction {
	...
	public BehaviourProvider getBehaviourProvider()
	{
		return new BehaviourProvider() {
			...
			{
				if(performer instanceof Player && source != null && object != null && source.getTemplateId() == EnchantersCrystal.getId() && object.getTemplateId() != EnchantersCrystal.getId()){
			...
			public boolean action(Action act, Creature performer, Item source, Item target, short action, float counter)
			{
				try{
					if(performer instanceof Player){
						if(source.getTemplate().getTemplateId() != EnchantersCrystal.getId()){
